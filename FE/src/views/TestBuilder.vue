<template>
  <div class="container-fluid py-4 bg-light" style="min-height: 100vh">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <select 
                v-model="form.id_lesson"
                :class="['form-select', { 'is-invalid': formErrors.id_lesson }]"
              >
            ...
            <div class="mb-3">
              ...
              <input 
                v-model="form.ten_bai_test"
                type="text" 
                :class="['form-control', { 'is-invalid': formErrors.ten_bai_test }]"
            ...
            <div class="mb-3">
              ...
              <textarea 
                ...
                class="form-control"
                rows="3"
                placeholder="Nhập mô tả cho bài test"
              ></textarea>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input 
                  v-model.number="form.thoi_gian_toi_da"
                  type="number" 
                  :class="['form-control', { 'is-invalid': formErrors.thoi_gian_toi_da }]"
                  min="1"
                  placeholder="60"
                >
              ...
              <div class="col-md-6 mb-3">
                ...
                <input 
                  v-model.number="form.diem_tong_max"
                  type="number" 
                  :class="['form-control', { 'is-invalid': formErrors.diem_tong_max }]"
                  min="1"
                  placeholder="100"
                >
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input 
                  v-model.number="form.so_lan_lam_toi_da"
                  type="number" 
                  class="form-control"
                  min="1"
                  placeholder="3"
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                <div class="form-check">
                  <input 
                    v-model="form.co_xao_tron_cau_hoi"
                    type="checkbox" 
              ...
              <div class="col-md-6 mb-3">
                <div class="form-check">
                  <input 
                    v-model="form.co_xao_tron_dap_an"
                    type="checkbox" 
                    class="form-check-input"
                    id="shuffleAnswers"
                  >
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                <div class="form-check">
                  <input 
                    v-model="form.hien_thi_ket_qua_ngay_lap"
                    type="checkbox" 
                    class="form-check-input"
              ...
              <div class="col-md-6 mb-3">
                <div class="form-check">
                  <input 
                    v-model="form.hien_thi_dap_an_dung"
                    type="checkbox" 
                    class="form-check-input"
    ...
    <QuestionEditor 
      ...
      :loai-cau-hoi="selectedQuestionType"
      @save="onQuestionSave"
...
const onSubmit = async () => {
  ...
  try {
    ...
    if (isEdit.value) {
      await testStore.updateTest(editTestId.value, testData);
      alert("Cập nhật bài test thành công!");
    } else {
      await testStore.createTest(testData);
  ...
  if (!isEdit.value) {
    ...
    if (preset) {
      try {
        ...
        form.value = { ...form.value, ...presetData };
